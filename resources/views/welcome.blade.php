        ...
        <form class="forms-sample">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="exampleInputName1" placeholder="nama"
                    @error('nama_mahasiswa') is-invalid @enderror" value="{{ old('nama_mahasiswa') }}"
            ...
            <div class="form-group">
                ...
                <input type="email" class="form-control" id="exampleInputEmail3" placeholder="Email"
                    @error('nim_mahasiswa') is-invalid @enderror" value="{{ old('nim_mahasiswa') }}"
                    name="nim_mahasiswa" id="nim_mahasiswa">
                @error('nim_mahasiswa')
                    <small class="text-danger">{{ $message }}</small>
                @enderror
            </div>
            ...
            <div class="form-group">
                ...
                <select name="id_jurusan" id="id_jurusan" class="form-select @error('id_jurusan') is-invalid @enderror"
            ...
            <div class="form-group">
                ...
                <input type="email" class="form-control" id="exampleInputEmail3" placeholder="Email"
                    @error('no_rek') is-invalid @enderror" value="{{ old('no_rek') }}"
