                ...
                <div class="col-lg-12">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('nama_operator') is-invalid @enderror"
                            value="{{ old('nama_operator') ?? $detail->nama_operator }}" name="nama_operator" id="nama_operator">
                        @error('nama_operator')
                ...
                <div class="col-lg-12">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('username') is-invalid @enderror"
                            value="{{ old('username') ?? $detail->username }}" name="username" id="username">
                        @error('username')
                            <small class="text-danger">{{ $message }}</small>
                        @enderror
                    </div>
                ...
                <div class="col-lg-6">
                    <div class="form-group">
                        ...
                        <input type="email" class="form-control @error('email_operator') is-invalid @enderror"
                            value="{{ old('email_operator') ?? $detail->email_operator }}" name="email_operator" id="email_operator">
                ...
                <div class="col-lg-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('no_telepon') is-invalid @enderror"
                            value="{{ old('no_telepon') ?? $detail->no_telepon }}" name="no_telepon" id="no_telepon">
                        @error('no_telepon')
                            <small class="text-danger">{{ $message }}</small>
                        @enderror
                    </div>
                ...
                <div class="col-lg-6">
                    <div class="form-group">
                        ...
                        <input type="password" class="form-control @error('password_operator') is-invalid @enderror"
                            value="{{ old('password_operator') ?? $detail->password_operator}}" name="password_operator" id="password_operator">
